...
PY_COMPILE_TARGETS = [
    ...
    "eval/autotutor_langgraph_shadow_isolation_smoke.py",
    "eval/autotutor_langgraph_transition_parity_eval.py",
    "eval/autotutor_langgraph_active_routing_smoke.py",
    "eval/autotutor_langgraph_active_transaction_smoke.py",
    "eval/autotutor_observation_provider_smoke.py",
    "eval/autotutor_comparator_sensitivity_smoke.py",
    "eval/autotutor_canary_aggregation_smoke.py",
    "eval/autotutor_canary_admission_smoke.py",
    "eval/autotutor_admission_performance_smoke.py",
    "eval/autotutor_schema_hotpath_smoke.py",
    "eval/autotutor_schema_hotpath_checks.py",
    "backend/autotutor_safety.py",
    "eval/autotutor_transition_timing_smoke.py",
    "eval/autotutor_rehearsals_smoke.py",
    "eval/autotutor_atomic_observation_smoke.py",
    "eval/weakpoint_streak_migration_smoke.py",
    "backend/alembic/versions/018_weakpoint_correct_streak.py",
    "eval/autotutor_atomic_observation_checks.py",
    "eval/autotutor_rehearsal_runner_smoke.py",
    "scripts/run_autotutor_rehearsals.py",
    "backend/agents/autotutor_timing.py",
    "scripts/autotutor_verification_summary.py",
    "eval/autotutor_existing_session_downgrade_smoke.py",
    "eval/autotutor_canary_evidence_smoke.py",
    "eval/autotutor_production_verification_smoke.py",
    "eval/autotutor_production_attestation_smoke.py",
    "eval/autotutor_production_execution_closure_smoke.py",
    ...
    "eval/autotutor_attestation_binding_smoke.py",
    ...
    "scripts/autotutor_verification_window.py",
    "eval/autotutor_verification_window_smoke.py",
...
PY_COMPILE_TARGETS.extend(
    [
        ...
        "backend/alembic/versions/014_autotutor_rollout_observation_v2.py",
        "backend/alembic/versions/015_autotutor_canary_observation_v3.py",
...
FAST_SUITES = [
    ...
    "autotutor_verification_window_smoke",
