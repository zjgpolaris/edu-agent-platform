...
CORE_SUITES = [
    ...
    "autotutor_retention_follow_up_eval",
    ...
    "autotutor_langgraph_shadow_isolation_smoke",
    "autotutor_langgraph_transition_parity_eval",
    "autotutor_langgraph_active_routing_smoke",
    "autotutor_langgraph_active_transaction_smoke",
    "autotutor_observation_provider_smoke",
    "autotutor_comparator_sensitivity_smoke",
    ...
    "autotutor_attestation_binding_smoke",
    "autotutor_scoped_verification_identity_smoke",
    "autotutor_verification_environment_bootstrap_smoke",
    "autotutor_verification_traffic_smoke",
    "autotutor_verification_traffic_security_smoke",
...
SUITE_FILES = {
    ...
    "autotutor_retention_follow_up_eval": EVAL_DIR / "autotutor_retention_follow_up_eval.py",
    ...
    "autotutor_langchain_provenance_smoke": EVAL_DIR / "autotutor_langchain_provenance_smoke.py",
    "autotutor_langgraph_shadow_parity_smoke": EVAL_DIR / "autotutor_langgraph_shadow_parity_smoke.py",
    "autotutor_langgraph_shadow_isolation_smoke": EVAL_DIR / "autotutor_langgraph_shadow_isolation_smoke.py",
    "autotutor_langgraph_transition_parity_eval": EVAL_DIR / "autotutor_langgraph_transition_parity_eval.py",
    ...
    "demo_contract_smoke": EVAL_DIR / "demo_contract_smoke.py",
    "demo_trace_projection_smoke": EVAL_DIR / "demo_trace_projection_smoke.py",
    "demo_trace_authorization_smoke": EVAL_DIR / "demo_trace_authorization_smoke.py",
    "demo_evidence_authorization_smoke": EVAL_DIR / "demo_evidence_authorization_smoke.py",
    ...
    "autotutor_comparator_sensitivity_smoke": EVAL_DIR / "autotutor_comparator_sensitivity_smoke.py",
    "autotutor_canary_aggregation_smoke": EVAL_DIR / "autotutor_canary_aggregation_smoke.py",
    "autotutor_canary_admission_smoke": EVAL_DIR / "autotutor_canary_admission_smoke.py",
    "autotutor_existing_session_downgrade_smoke": EVAL_DIR / "autotutor_existing_session_downgrade_smoke.py",
    "autotutor_canary_evidence_smoke": EVAL_DIR / "autotutor_canary_evidence_smoke.py",
    "autotutor_production_verification_smoke": EVAL_DIR / "autotutor_production_verification_smoke.py",
    "autotutor_production_attestation_smoke": EVAL_DIR / "autotutor_production_attestation_smoke.py",
    "autotutor_production_remote_cli_smoke": EVAL_DIR / "autotutor_production_remote_cli_smoke.py",
    "autotutor_production_verification_api_smoke": EVAL_DIR / "autotutor_production_verification_api_smoke.py",
    "autotutor_production_workflow_contract_smoke": EVAL_DIR / "autotutor_production_workflow_contract_smoke.py",
    "autotutor_production_rollback_verification_smoke": EVAL_DIR / "autotutor_production_rollback_verification_smoke.py",
    "autotutor_canary_writer_failure_smoke": EVAL_DIR / "autotutor_canary_writer_failure_smoke.py",
...
SUITE_METADATA: dict[str, dict[str, str]] = {
    ...
    "demo_contract_smoke": {
        "label": "Pilot Demo 数据合同 Smoke",
        "category": "product",
        "kind": "smoke",
        "priority": "p0",
    },
    "demo_trace_projection_smoke": {
        "label": "AutoTutor Demo 脱敏轨迹 Smoke",
        "category": "observability",
        "kind": "smoke",
        "priority": "p0",
    },
    "demo_trace_authorization_smoke": {
        "label": "AutoTutor Demo 轨迹授权 Smoke",
        "category": "safety",
        "kind": "smoke",
        "priority": "p0",
    },
    "demo_evidence_authorization_smoke": {
        "label": "AutoTutor 会话证据授权 Smoke",
        "category": "safety",
        "kind": "smoke",
        "priority": "p0",
    },
    ...
    "autotutor_langchain_provenance_smoke": {
        "label": "AutoTutor LangChain 决策来源 Smoke",
        "category": "agent",
        "kind": "smoke",
        "priority": "p0",
    },
    "autotutor_langgraph_shadow_parity_smoke": {
        "label": "AutoTutor LangGraph Shadow 对等性 Smoke",
        "category": "agent",
        "kind": "smoke",
        "priority": "p0",
    },
    "autotutor_langgraph_shadow_isolation_smoke": {
        "label": "AutoTutor LangGraph Shadow 隔离性 Smoke",
        "category": "agent",
        "kind": "smoke",
        "priority": "p0",
    },
    "autotutor_langgraph_transition_parity_eval": {
        "label": "AutoTutor LangGraph 独立状态转移 Parity",
        "category": "agent",
        "kind": "quality",
        "priority": "p0",
    },
