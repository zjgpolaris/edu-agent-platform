...
def main() -> None:
    ...
    original_search = history_search.search_with_scores
    history_search.search_with_scores = lambda *args, **kwargs: [relevant, broad_but_relevant, unrelated]
    try:
        result = history_search.search_history_knowledge({"query": "苏轼做了什么", "topic": "苏轼", "k": 4})
    finally:
        history_search.search_with_scores = original_search
    ...
    history_search.search_with_scores = lambda *args, **kwargs: [
